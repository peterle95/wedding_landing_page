...
const translations: Translations = {
  ...
  uploadDescription: {
    ...
    it: 'Carica le tue foto e i tuoi video nel nostro album condiviso.',
    ru: 'Загрузите ваши фото и видео в наш общий альбом.',
    de: 'Lade deine Fotos und Videos in unser gemeinsames Album hoch.',
  },
  uploadButton: {
    en: 'Upload',
    it: 'Carica',
